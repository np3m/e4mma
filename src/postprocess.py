...
purpose: Postprocess Crust_DFT output files.

This script provides functionality to postprocess output files generated by the Crust_DFT model.
...
def main():
    ...
    It copies specific Crust_DFT output files, creates an output directory if needed, and performs data slicing.
    ...
    # Copy Crust_DFT output files
    Crust_DFT_output_files = ["crust_dft.csv"]
    #for file_name in Crust_DFT_output_files:
    #    shutil.copy(
    ...
    # Process Crust_DFT output for Lepton
    print(f"Processing Crust-DFT output: ...")

    porter.import_table(
        os.path.join(output_directory_run, f"crust_dft.csv"),
        extension="CSV",
    ...
    if yaml_input.get("output_format", "") == "HDF5":
        ...
        porter.export_table(
            os.path.join(
                output_directory, f"crust_dft.h5"
            ),
            filename_schema="../api/OpenAPI_Specifications_UTK.yaml",
            schema="e4mma_wo_lepton",
            extension="HDF5",
        ...
        # Export data to an CSV file following the OpenAPI specifications Crust_DFT_output_for_Lepton
        porter.export_table(
            os.path.join(
                output_directory, f"crust_dft.csv"
            ),
            extension="CSV",
            filename_schema="../api/OpenAPI_Specifications_UTK.yaml",
            schema="e4mma_wo_lepton",
